...
The code below imports and cleans data from the `Mr. Trash Wheel` sheet in file `Trash-Wheel-Collection-Totals-7-2020-2.xlsx`. The process begins with data import, update variable names, omit rows that do not include dumpster-specific data, round the number of sports balls to the nearest integer and converts the result to an integer variable. As part of data import, I specify cell range for reading so as to omit non-data entries. 
